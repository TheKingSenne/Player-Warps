...
public enum MessagePathAndDefault {
    ...
    CANT_AFFORD_MONEY("cantAffordMoney", "Error: You can't afford a new warp. A new warp costs PMONEYAMOUNTP."),
    CREATED_ITEM_PAID_WARP("createdItemPaidWarp", "You have created a new warp and have paid PITEMAMOUNTP PITEMP."),
    CREATED_MONEY_PAID_WARP("createdMoneyPaidWarp", "You have created a new warp and have paid PMONEYAMOUNTP."),
    ...
    RELOAD_PLUGIN("reloadedPlugin", "PWarp has been reloaded"),
    ...
    LIMIT_ABOVE_0("limitAbove0", "Error: Please specifiy a number above 0."),
    LIMIT_CHANGED("changedLimit", "You have changed the warplimit."),
    CONFIGURED_WRONG("configuredWrong", "Error: This warp cannot be found or is configured wrong."),
    ...
    UPDATED_LORE("updatedLore", "You have changed your warplore."),
    RESET_LORE("resetLore", "You have reset your warplore."),
    ...
    RESET_WARP_ICON("resetIcon", "Your warp icon has been reset."),
    ...
    HIDDEN_UNHIDDEN("hiddenUnhidden", "You have succesfully hidden/unhidden your warp."),
    ...
    HELP_RELOAD("helpReload", "Reloads the configuration files."),
    ...
    HELP_RESETLORE("helpResetLore", "Resets your warp lore."),
    ...
    HELP_RESETITEM("helpResetItem", "Sets your warpicon to the default item."),
