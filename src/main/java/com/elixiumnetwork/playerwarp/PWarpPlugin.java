            ...
            if (sender instanceof Player) {
                ...
                if (args[0].equalsIgnoreCase("help")) {
                    ...
                    if (args[0].equalsIgnoreCase("setlimit") || args[0].equalsIgnoreCase("limit")) {
                        ...
                        if (args.length != 2) {
                            sender.sendMessage(ChatColor.RED + Messages.CORRECT_USAGE.getMessage().replaceAll("PUSAGEP", "/pwarp setprivate <warp>"));
                            return true;
                        }
                        ...
                        sender.sendMessage(ChatColor.GREEN + Messages.MADE_PRIVATE.getMessage());
                        return true;
                    }
                        ...
                        if (args.length != 2) {
                            sender.sendMessage(ChatColor.RED + Messages.CORRECT_USAGE.getMessage().replaceAll("PUSAGEP", "/pwarp setpublic <warp>"));
                            return true;
                        }
                        if (this.wF.getWarpFile().getString("warps." + args[1].toLowerCase()) == null) {
                            sender.sendMessage(ChatColor.RED + Messages.WARP_NOT_EXISTING.getMessage());
                        ...
                        sender.sendMessage(ChatColor.GREEN + Messages.MADE_PUBLIC.getMessage());
                        return true;
                    }
                        ...
                        if (args.length != 3) {
                            sender.sendMessage(ChatColor.RED + Messages.CORRECT_USAGE.getMessage().replaceAll("PUSAGEP", "/pwarp trust <warp> <player>"));
                            return true;
                        }
                        OfflinePlayer trustedPlayer = null;
                        try {
                            trustedPlayer = Bukkit.getOfflinePlayer(args[2]);
                        }
                        catch (Exception e3) {
                            sender.sendMessage(ChatColor.RED + Messages.PLAYER_NOT_EXISTING.getMessage());
                            return true;
                        }
                        if (!trustedPlayer.hasPlayedBefore()) {
                            sender.sendMessage(ChatColor.RED + Messages.PLAYER_NOT_EXISTING.getMessage());
                            return true;
                        }
                        this.warp.setTrust(this, sender, trustedPlayer, args[1], true);
                        return true;
                    }
                        ...
                        if (args.length != 3) {
                            sender.sendMessage(ChatColor.RED + Messages.CORRECT_USAGE.getMessage().replaceAll("PUSAGEP", "/pwarp untrust <warp> <player>"));
                            return true;
                        }
                        OfflinePlayer trustedPlayer = null;
                        try {
                        ...
                        this.warp.setTrust(this, sender, trustedPlayer, args[1], false);
                        return true;
                    }
                        ...
                        if (args.length != 2) {
                            sender.sendMessage(ChatColor.RED + Messages.CORRECT_USAGE.getMessage().replaceAll("PUSAGEP", "/pwarp setitem <warp>"));
                            return true;
                        }
                        this.warp.setItem(this, sender, args[1]);
                        return true;
                    }
